...
function isAccordion() {
  document.querySelectorAll('.acc').forEach(function (acc) {
    var accBtn = acc.querySelector('.acc__trigger');
    var accPanel = acc.querySelector('.acc__panel');
...
function isMenuProductItems() {
  var btn = document.querySelector('.nav__link_product');
  var menu = document.querySelector('.menu__product-menu');
...
;// CONCATENATED MODULE: ./src/js/modules/choices.js

document.querySelectorAll('.select').forEach(function (choicesEl) {
  var choices1 = new choices(choicesEl, {
    searchEnabled: false,
    position: 'bottom',
    itemSelectText: '',
    shouldSort: false,
...
document.querySelectorAll('.select-2').forEach(function (choicesEl) {
  var choices2 = new choices(choicesEl, {
    searchEnabled: false,
    position: 'bottom',
    itemSelectText: '',
    shouldSort: false,
