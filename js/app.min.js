...
var swiperNav1 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper.swiper-nav', {
...
var swiperNav1El = swiperNav1.$el[0];
setActiveSlideNum();
...
function setActiveSlideNum() {
  var activeSlideNum = swiperNav1El.querySelector('.swiper-active-slide-num');
  activeSlideNum.innerHTML = swiperNav1.activeIndex + 1;
}

var swiperQuiz = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper.home-quiz__swiper', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
  // Navigation arrows
  navigation: {
    nextEl: '.swiper-button-next',
